...
private val LightColorPalette = EventColors(
    brand = Shadow5,
...
private val DarkColorPalette = EventColors(
    brand = Shadow1,
...
class EventColors(
    ...
    fun copy(): EventColors = EventColors(
...
private val LocalEventColors = staticCompositionLocalOf<EventColors> {
    error("No EventColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [EventTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
